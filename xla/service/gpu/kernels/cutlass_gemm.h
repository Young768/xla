...
// pre-compiled shared libraries from disk. Libraries can be compiled at run
// time using external toolchains, e.g. NVCC, as long as they export required
...
// shared libraries (see Adaptor specialization above).
template <>
