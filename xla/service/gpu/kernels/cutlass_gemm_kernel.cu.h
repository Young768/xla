...
#include "include/cutlass/gemm/gemm_enumerated_types.h"
#include "include/cutlass/gemm_coord.h"
#include "include/cutlass/layout/matrix.h"
...
KernelArgsPacking ArgsPacking(cutlass::gemm::GemmCoord problem_size,
  ...
  return [=](const se::KernelArgs &args) -> PackedArgs {
    ...
    // Parameters for `LinearCombination` epilogue.
