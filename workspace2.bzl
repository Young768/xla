...
def _tf_repositories():
    ...
    tf_http_archive(
        ...
        sha256 = "e20a0c54b897ab09b7c657f4a031198152114119bce0c0ba4d95c9631b4a97f6",
        strip_prefix = "cutlass-3.2.1",
        urls = tf_mirror_urls("https://github.com/NVIDIA/cutlass/archive/refs/tags/v3.2.1.zip"),
    )
